...
**This app uses those images only for personal, self-hosted in-app reference.** They are copied into your own Cloudflare R2 bucket at seed time — nothing is fetched from a third-party CDN at runtime. Do not republish the image pack as a standalone dataset or API.
