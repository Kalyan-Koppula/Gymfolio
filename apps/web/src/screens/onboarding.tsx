...
// Onboarding stops at personalization — the routine is built afterward from Train, where the
// full day editor lives, so a first-run user isn't asked to design a split before they've
// seen the app.
const STEPS = ["Account", "Hydration goal", "Macro target", "Equipment"]
const [ACCOUNT, HYDRATION, MACRO, EQUIPMENT] = [0, 1, 2, 3]
  ...
  return (
    <div className="mx-auto flex min-h-svh max-w-md flex-col px-6 py-8" style={{ paddingTop: "var(--safe-top)" }}>
      ...
      <div className="mt-8 flex gap-3">
        ...
        <Button className="h-11 flex-1 text-base" onClick={next} disabled={isSaving}>
